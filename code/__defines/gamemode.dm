...
#define ANTAG_SET_APPEARANCE_H  0x1000 // Causes antagonists to use an appearance modifier on spawn, human and IPC species only.
...
#define MODE_TERRORIST     "terrorist"
