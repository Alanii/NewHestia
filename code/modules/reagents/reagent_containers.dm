...
/obj/item/weapon/reagent_containers/examine(mob/user)
	...
	if(hasHUD(user, HUD_SCIENCE))
		...
		to_chat(user, "<span class='notice'>Using your chemistry knowledge, you identify the following reagents in \the [src]: [reagents.get_reagents(!user.skill_check(SKILL_CHEMISTRY, SKILL_SPEC), 5)].</span>")
