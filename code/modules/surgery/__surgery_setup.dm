...
#define  SURGERY_SKILLS_ROBOTIC				list(SKILL_DEVICES = SKILL_EXPERT)
#define  SURGERY_SKILLS_ROBOTIC_ON_MEAT		list(SKILL_ANATOMY = SKILL_ADEPT, SKILL_DEVICES = SKILL_EXPERT) 
