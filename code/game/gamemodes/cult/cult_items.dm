...
/obj/item/weapon/melee/cultblade/attack(mob/living/M, mob/living/user, var/target_zone)
	...
	if(affecting)
		to_chat(user, "<span class='cult'>An unexplicable force rips through your [affecting.name], tearing the sword from your grasp!</span>")
	else
		to_chat(user, "<span class='cult'>An unexplicable force rips through you, tearing the sword from your grasp!</span>")
