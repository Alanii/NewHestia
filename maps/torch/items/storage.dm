...
/obj/item/gunbox/bodyguard/attack_self(mob/living/user)
	...
	options["Ballistic"] = list(/obj/item/weapon/gun/projectile/pistol/military,/obj/item/ammo_magazine/pistol/double/rubber)
	options["Energy"] = list(/obj/item/weapon/gun/energy/gun/secure/corporate)
	options["Taser - Stun"] = list(/obj/item/weapon/gun/energy/stunrevolver/secure/nanotrasen)
