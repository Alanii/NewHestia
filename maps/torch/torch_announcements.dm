/datum/map/torch
	...
	emergency_shuttle_called_sound = sound('sound/AI/torch/abandonship.ogg', volume = 75)

	emergency_shuttle_recall_message = "Attention all hands: emergency evacuation sequence aborted. Return to normal operating conditions."

	command_report_sound = sound('sound/AI/torch/commandreport.ogg', volume = 75)
	...
	grid_check_sound = sound('sound/AI/torch/poweroff.ogg', volume = 75)

	grid_restored_message = "Ship power to the %STATION_NAME% will be restored at this time"
	grid_restored_sound = sound('sound/AI/torch/poweron.ogg', volume = 75)

	meteor_detected_sound = sound('sound/AI/torch/meteors.ogg', volume = 75)
	...
	radiation_detected_sound = sound('sound/AI/torch/radiation.ogg', volume = 75)

	space_time_anomaly_sound = sound('sound/AI/torch/spanomalies.ogg', volume = 75)
	...
	unidentified_lifesigns_sound = sound('sound/AI/torch/aliens.ogg', volume = 75)

	lifesign_spawn_sound = sound('sound/AI/torch/aliens.ogg', volume = 75)

	electrical_storm_moderate_sound = sound('sound/AI/torch/electricalstormmoderate.ogg', volume = 75)
	electrical_storm_major_sound = sound('sound/AI/torch/electricalstormmajor.ogg', volume = 75)

/datum/map/torch/level_x_biohazard_sound(var/bio_level)
	switch(bio_level)
		if(7)
			return sound('sound/AI/torch/outbreak7.ogg', volume = 75)
		else
			return sound('sound/AI/torch/outbreak5.ogg', volume = 75)
