...
/datum/shuttle/autodock/overmap/skrellscoutship
	...
	shuttle_area = list(
		...
		/area/ship/skrellscoutship/dock, /area/ship/skrellscoutship/dock/alt,
		...
		/area/ship/skrellscoutship/crew/brig, /area/ship/skrellscoutship/crew/infirmary, /area/ship/skrellscoutship/crew/cloning
		)
